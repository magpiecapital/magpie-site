...
export const alt = "Magpie Referrals — earn 10% of every loan fee from anyone you refer.";
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 32, fontSize: 18 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ fontWeight: 700, color: "#0a0a0a", fontSize: 24 }}>5%</div>
              of every fee
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ fontWeight: 700, color: "#0a0a0a", fontSize: 24 }}>Lifetime</div>
              not a one-shot
            </div>
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              <div style={{ fontWeight: 700, color: "#0a0a0a", fontSize: 24 }}>SOL</div>
              real yield
            </div>
          </div>
          <div style={{ fontWeight: 600, color: "#0a0a0a" }}>magpie.capital/refer</div>
        </div>
      </div>
    ),
    { ...size },
