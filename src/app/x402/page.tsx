          ...
          <div className="rounded-2xl border border-[var(--ink)]/15 bg-[var(--ink)]/[0.02] p-6 md:p-8">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className="rounded-xl border border-[var(--ink)]/10 p-4">
                ...
                <span className="block text-xs text-[var(--ink-soft)] mt-2">9 tools, zero keys: live borrow quotes, catalog, stats, the credit league, and a safety brief. Registry <code className="font-mono">io.github.magpiecapital/magpie</code></span>
              </div>
              <div className="rounded-xl border border-[var(--ink)]/10 p-4">
                ...
                <span className="block text-xs text-[var(--ink-soft)] mt-2">All 26 x402 tools — borrow, arm/modify exits, repay. Add a payer keypair and your agent acts for real. Registry <code className="font-mono">io.github.magpiecapital/magpie-mcp</code></span>
              </div>
            </div>
            <div className="flex flex-wrap gap-2 text-xs font-mono">
              {["magpie_borrow_quote", "magpie_safety_brief", "magpie_list_collateral", "magpie_token_terms", "magpie_agent_leaderboard", "magpie_wallet_loans", "magpie_protocol_stats", "magpie_x402_guide"].map((t) => (
