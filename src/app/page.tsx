...
const FAQ = [
  ...
  },
  {
    ...
    a: "Nothing — a price drop never liquidates you. Loans are fixed-term: no margin calls, no health-factor liquidations. Repay, partial-repay, or extend anytime. One hard rule: miss the due date and the collateral is forfeit, including any upside.",
  },
  {
    q: "Is it custodial?",
